...
const UserPage = () => {
    ...
    const handleSubmit = async () => {
        if(cardData?.title !== undefined && cardData?.answer !== undefined && cardData?.name !== undefined && cardData?.title !== "" && cardData?.answer !== "" && cardData?.name !== "") {
    ...
    return (
        <div>
            <div id={"userContainer"}>
                ...
                <div id={"userTitle"} className={"title"} onClick={() => navigate("/academia_boardgame/")}> ACADEMIA </div>

                <Card initialName={userType === "moderator"? "Resposta certa" : name} onUpdate={(cardData: CardData) => handleCardSubmit(cardData)}/>
                <div id={"cardSubmit"}>
